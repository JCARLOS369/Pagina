...
body {
  ...
  background-image: url('escudo.png');  /* 👈 Cambia a tu ruta */
  background-size: 315px auto;         /* 👈 Tamaño personalizado: ancho 300px */
  background-repeat: no-repeat;        /* Que no se repita */
  background-position: left 10px top 300px;       /* 👈 Posición inicial (izquierda arriba) */
  background-attachment: fixed;        /* Para que quede fija si haces scroll */
...
<body>
  ...
  <div class="banner-superior">INICIO DE SESIÓN ALMACÉN VALLE DE CHALCO SOLIDARIDAD</div>
